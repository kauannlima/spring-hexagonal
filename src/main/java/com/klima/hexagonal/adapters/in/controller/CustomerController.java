package com.klima.hexagonal.adapters.in.controller;

import com.klima.hexagonal.adapters.in.controller.mapper.CustomerMapper;
...
import com.klima.hexagonal.application.ports.in.DeleteCustomerByIdInputPort;
...
import com.klima.hexagonal.application.ports.in.UpdateCustomerInputPort;
...
public class CustomerController {
    ...
    @DeleteMapping("/{id}")
    private ResponseEntity<Void> delete(@PathVariable("id") final String id) {
